...
PostDown = iptables -D FORWARD -i wg0 -j ACCEPT; iptables -t nat -D POSTROUTING -o wg0 -j MASQUERADE;" >>"/etc/wireguard/wg0.conf"

iptables -t nat -I POSTROUTING -s 10.66.66.1/24 -o wg0 -j MASQUERADE
iptables -I INPUT 1 -i wg0 -j ACCEPT
iptables -I FORWARD 1 -i wg0 -o wg0 -j ACCEPT
iptables -I FORWARD 1 -i wg0 -o wg0 -j ACCEPT
iptables -I INPUT 1 -i wg0 -p udp --dport 5820 -j ACCEPT
